        ...
        <div className="space-y-6">
          ...
          <div className="p-4 border-2 border-[#444] dark:border-[#888] border-dashed rounded-lg bg-white/50 dark:bg-black/20">
            ...
            <textarea 
              ...
              className="w-full h-48 p-3 pencil-text text-sm bg-white dark:bg-[#111] text-black dark:text-white border-2 border-[#444] dark:border-[#888] rounded-[10px_5px_20px_5px] focus:outline-none focus:ring-1 focus:ring-black/20 resize-none"
            />
          </div>

          <div className="text-center opacity-40">
             <p className="pencil-text text-xs">API is automatically managed via system environment.</p>
          </div>
        </div>
      </div>
    </div>
